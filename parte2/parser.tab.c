...
{
       0,    84,    84,    85,    88,    89,   102,   113,   125,   126,
     134,   143,   151,   161,   162,   170,   181,   183,   185,   186,
     187
};
#endif
...
{
  "$end", "error", "$undefined", "IDENTIFICADOR", "PALAVRA_RESERVADA",
  "NUMERO", "PONTO_FLUTUANTE", "VARIAVEL", "OPERADOR_UNARIO",
  "OPERADOR_LOGICO", "OPERADOR_ATRIBUICAO", "OPERADOR_SOMA",
  "OPERADOR_MUL", "OPERADOR_SUB", "OPERADOR_DIV", "CONDICIONAL", "LOOP",
  "STRING", "CARACTER", "VETOR", "TAMANHO_VETOR", "EXCLAMACAO", "EOL",
  "$accept", "calc", "stmt", "exp", "fator", "loop", "operador", "termo", YY_NULLPTR
};
#endif
...
{
     -17,     6,   -17,   -17,   -17,   -17,    58,   -17,     1,    49,
      -4,    58,   -17,    42,   -17,   -17,    58,    58,    58,    58,
      58,    58,    34,    26,    -4,    -4,    -4,    -4,   -17,   -17,
      26,    10,    18,    58,   -17,   -17,    23,    18,   -17
};
...
{
       2,     0,     1,    18,    19,    20,     0,    16,     0,     4,
       8,     0,    13,     0,     3,    17,     0,     0,     0,     0,
       0,     0,     0,     0,    11,     9,    10,    12,    14,    15,
       0,     0,     0,     0,     7,     6,     8,     0,     5
};
...
{
      13,    24,    25,    26,    27,    22,     2,    31,    20,    30,
      21,     3,     4,     5,    32,    28,    29,    33,    36,    35,
      37,     6,     7,    14,    38,    34,     0,    22,     3,     4,
       5,     3,     4,     5,     7,    20,     0,    21,     6,     7,
       0,     6,     7,    15,    16,    17,     0,    18,     0,     0,
       7,    15,    16,    17,     0,    18,     0,    23,    15,    16,
      17,     0,    18,     3,     4,     5
};

static const yytype_int8 yycheck[] =
{
       6,    16,    17,    18,    19,    11,     0,    23,    12,    22,
      14,     5,     6,     7,    30,    20,    21,    30,    33,    32,
      36,    15,    16,    22,    37,    15,    -1,    33,     5,     6,
       7,     5,     6,     7,    16,    12,    -1,    14,    15,    16,
      -1,    15,    16,     9,    10,    11,    -1,    13,    -1,    -1,
      16,     9,    10,    11,    -1,    13,    -1,    15,     9,    10,
      11,    -1,    13,     5,     6,     7
};
...
{
       0,    24,     0,     5,     6,     7,    15,    16,    25,    26,
      27,    28,    30,    26,    22,     9,    10,    11,    13,    29,
      12,    14,    26,    15,    27,    27,    27,    27,    30,    30,
      28,    25,    25,    28,    15,    28,    27,    25,    28
};
...
#line 89 "parser.y" /* yacc.c:1646  */
    {
                            ...
                            (yyval.no) = novo_no("stmt", filhos, 7);
    }
...
#line 102 "parser.y" /* yacc.c:1646  */
    {
                            ...
                            (yyval.no) = novo_no("stmt", filhos, 5);
    }
...
#line 113 "parser.y" /* yacc.c:1646  */
    {                               
                            ...
                            filhos[1] = (yyvsp[-3].no);
                            filhos[2] = (yyvsp[-2].simbolo);
                            filhos[3] = (yyvsp[-1].no);
                            filhos[4] = (yyvsp[0].simbolo);
